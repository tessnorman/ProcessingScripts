...
import urllib, urllib2, xlrd, unicodedata, time, json

###USER Variables
inputExcelDocument = r"C:\Temp\WBES_Cities.xls"
outputDoc = open(r"C:\Temp\WBES_Cities.tsv", 'w')
...
def getGeogLocation (location, data, headers):
    location2 = urllib2.quote(location) # get the internet version of the location string
